	 ...
	 <!-- /HEADER ROW -->
		...
		<div class="container">
		  ...
		  <!-- /. PAGE TITLE-->
		  	...
		  	<%
		  		if (request.getAttribute("msgdsbtdoc")!=null)
		  		{	  		
		  	%>
		  		<div class="row">	
						...
						<div class="span6">			
								<div class="media">
									 <p style="color:red">${msgdsbtdoc}</p>
								</div>						
						</div>	
		  	...
		  	%>
			<div class="row">	
					<c:forEach items="${danhsachbtdoc}" var="list">
						<div class="span6">			
								<div class="media">
									 <a href="#" class="pull-left"><img src="Imageandfilebtdoc/${list.readimage}" class="media-object" alt='' width="128px" height="128px"/></a>
