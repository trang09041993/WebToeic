...
/**
 * Servlet implementation class ListGrammarForward
 */
...
public class ListGrammarForward extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		List<Grammar> list = ListGrammAdmin.Displaygrammarguideline(pageid, count, conn);
		
		
		int sumrow = ListGrammAdmin.Countrow(conn);
		int maxpageid= 0;
