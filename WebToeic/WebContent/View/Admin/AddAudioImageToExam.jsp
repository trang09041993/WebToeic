...
<title>Add Audio Image To Exam</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Add audio and image in exam
											</h4>

											<div class="space-6"></div>

											<form action="AddAudioImageToExam" method="POST" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="clearfix">
														...
														<input type="submit" value="Add audio+image" class="btn btn-sm btn-primary">
													 	<input id="addFile" type="button" value="choose file" class="btn btn-sm btn-primary"/>
