...
<body class="no-skin">	
	<!-- Header -->
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
							...
							<c:if test="${msgquanlydethi!=null}">
								<h4 class="pink">								
										<a class="green" data-toggle="modal">${msgquanlydethi}</a>
								</h4>
														...
														<tr>
															...
															<td class="center">
																<ul class="list-unstyled">
																	...
																	<c:if test="${list.checkedcauhoi==0}">
																		<li>
											...
											<div>
												<ul class="pagination">
													<c:if test="${numberpage == 1}">
													   ...
													   <li><a href = "ExamDisplayAdmin?pageid=${numberpage+1}">Next</a></li>
												   </c:if>
												   <c:if test="${numberpage == maxpageid}">
													   <li><a href = "ExamDisplayAdmin?pageid=${numberpage-1}">Prev</a></li>
	  ...
	  <div class="modal fade" id="myModal" role="dialog">
	    ...
	    <form action="AddNameExam" method="POST">
		      <!-- Modal content-->
