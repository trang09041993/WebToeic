...
<body class="no-skin">	
	<!-- Header -->
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Add Grammar Lession</li>
									...
									<div class="row">
										<div class="col-xs-12">
											<table id="simple-table" class="table  table-bordered table-hover">
												...
												<tbody>			
													<c:forEach items="${ListGrammarAdmin}" var ="list">
														<tr>
															<td class="center">
														 ...
														 <td class="center">
																<a class="red" href="DeleteGrammarLession?grammarguidelineid=${list.grammarGuidelineId}">
															...
															<td class="center">
																<a class="green" href="AddGrammarContentForward?id=${list.grammarGuidelineId}">
											...
											<div>
												<ul class="pagination">
													<c:if test="${numberpage == 1}">
													   ...
													   <li><a href = "AddGrammarController?pageid=${numberpage+1}">Next</a></li>
												   </c:if>
												   <c:if test="${numberpage == maxpageid}">
													   <li><a href = "AddGrammarController?pageid=${numberpage-1}">Prev</a></li>
	  ...
	  <div class="modal fade" id="myModal" role="dialog">
	    ...
	    <form action="InsertgrammarName" method="POST">
		      <!-- Modal content-->
