								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="AddImageExam?examinationid=<%=request.getAttribute("examinationid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<%=request.getAttribute("msgthemhinhdethi")!=null?request.getAttribute("msgthemhinhdethi"):" "%>
													</label>
													
													<label class="block clearfix">
														Add file: <input type="file" name="file" class="btn btn-white btn-warning btn-bold">
													</label>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-70 pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Add image of exam</span>
														</button>
