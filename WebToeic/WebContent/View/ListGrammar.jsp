						...
						<div class="span6">			
								<div class="media">
									...
									<div class="media-body">
										...
										<a href="ListGrammarDetail?mabaihdnguphap=${list.grammarGuidelineId}" class="btn" type="button">Chi tiết</a>
					...
					<div class="pagination">
						<ul>
							<c:if test="${numberpage == 1}">
							   ...
							   <li><a href = "ListGrammarForward?pageid=${numberpage+1}">Next</a></li>
						   </c:if>
						   <c:if test="${numberpage == maxpageid}">
							   <li><a href = "ListGrammarForward?pageid=${numberpage-1}">Prev</a></li>
