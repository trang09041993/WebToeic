		  ...
		  <!-- /. PAGE TITLE-->
			...
			<div class="row">	
					<c:forEach items="${danhsachhdtuvung}" var="list">
						<div class="span6">			
								<div class="media">
									 <a href="#" class="pull-left"><img src="ImageAudioVocab/${list.vocabularyimage}" class="media-object" alt='' width="128px" height="128px"/></a>
									<div class="media-body">
										...
										<a href="VocabularyContentDisplay?vocabularyguidelineid=${list.vocabularyguidelineid}" class="btn" type="button">Xem nội dung chủ đề</a>
									</div>
								</div>						
						</div>	
					</c:forEach>				
