				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="AddGrammarController">Grammar</a>
							</li>
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-sm-7">
										<h4 class="header green">Grammar Content</h4>
										<h4 class="pink">					
										...
										<div class="widget-box widget-color-blue">
											...
											<form action="AddGrammarContent?grammarguidelineid=<%=request.getAttribute("grammarguidelineid")%>" method="POST">
