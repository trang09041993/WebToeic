...
<link href="Template/FrontendAdmin/css/bootstrap-responsive.css"
	rel="stylesheet">
...
<body onLoad="auto_submit1();">
	...
	<div class="container">
		...
		<div class="row">
				...
				<div id="paginationdemo" class="thumbnail">
					<div class="reading_description" style="overflow: auto; height: 400px" >
							<div id="p1" class=" _current" style="">
								<h1 class="khoangcach">Click page 2 to test exam!
								</h1>
							</div>
							...
							<c:forEach items="${dscauhoi}" var ="list">
								<c:if test="${(list.imagequestion!='')&&(list.audiogg!='')&&(list.audiomp3!='')}">
									<div id="p${list.num+1}" style="display:none;">						
										<img src= "ImageAudioExam/${list.imagequestion}" alt="" style="width:250px;height:150px;"/>
											<br/>
											<br/>
											<p>
											...
											<b>Quiz ${list.num}. ${list.question}</b>
											<p>${list.option1}</p>
											<p>${list.option2}</p>
											<p>${list.option3}</p>
											<p>${list.option4}</p>							
			...
			<form name="form" action="ExamToDo?examinationid=${examinationid}&memberid=${memberid}" method="POST">
				<div class="span4">
					<div class="thumbnail">
						<div class="reading_description" style="overflow: auto; height: 400px" >
